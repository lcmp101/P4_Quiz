...
// Modelo de datos.
//
// En esta variable se mantinen todos los quizzes existentes.
// Es un array de objetos, donde cada objeto tiene los atributos question
// y answer para guardar el texto de la preunta y respuesta.
let quizzes = [
    {
 ...
 * Carga las preguntas
 * 
 * Este metodo carga el contenido del fichero DB_FILENAME en la variable quizzes.
 * El contenido de ese fichero está en formato JSON.
 * La primera vez que se ejecute este metodo, el fichero DB_FILENAME no existe, y se producirá el error ENOENT. En este caso, se salva el contenido inicial almacenado en quizzes. Si se produce otro tipo de error, se lanza una excepcion que abortará la ejecucion del programa.
 */
 const load = () => {
 ...
 * Si se produce algun tipo de error, se lanza una excepcion que abortará la ejecucion del programa.
 */
 const save = () => {
 ...
 * 
 * Devuelve un clon del valor guardado en la variable quizzes, devuelve un objeto nuevo con todas las preguntas existentes.
